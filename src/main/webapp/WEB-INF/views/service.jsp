...
<section>
	<div class="container">
		...
		<p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing
			elit. Curabitur pellentesque neque eget diam posuere porta. Quisque
			ut nulla at nunc vehicula lacinia. Proin adipiscing porta tellus, ut
			feugiat nibh adipiscing sit amet.</p>
		...
		<article class="row">
			...
			<!-- 
				...
				<p>Enim ipsam voluptatem quia voluptas sit aspernatur aut odit
		...
		<div class="row">
			<div class="col-md-3 col-xs-6">
				<div class="text-center">
					...
					<a href="#"> Read <!-- /word rotator --> <span
						class="word-rotator" data-delay="2000"> <span class="items">
								<span>more</span> <span>now</span>
						</span>
					</span>
					<!-- /word rotator --> <i
						class="glyphicon glyphicon-menu-right fs-12"></i>
					</a>
