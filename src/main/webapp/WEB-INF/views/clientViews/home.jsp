...
<li data-transition="random" data-slotamount="1"
				...
				data-thumb="${res}/myImages/Home/s1-1.jpg"><img
				src="${res}/myImages/Home/s1-1.jpg"				
...
<!-- 
				<div class="tp-caption customin ltl tp-resizeme small_light_white"
					data-x="center" data-y="330"
					data-customin="x:0;y:150;z:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
					data-speed="800" data-start="1400" data-easing="easeOutQuad"
					data-splitin="none" data-splitout="none" data-elementdelay="0.01"
					data-endelementdelay="0.1" data-endspeed="1000"
					data-endeasing="Power4.easeIn"
					style="z-index: 10; width: 750px; max-width: 750px; white-space: normal; text-align: center; font-size: 20px;">
					<span class="font-lato"> Fabulas definitiones ei pri per
						recteque hendrerit scriptorem in errem scribentur mel fastidii
						propriae philosophia cu mea. </span>
				</div> -->
</li>
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s1-2.jpg"><img
				src="${res}/myImages/Home/s1-2.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s1-3.jpg"><img
				src="${res}/myImages/Home/s1-3.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s2-1.jpg"><img
				src="${res}/myImages/Home/s2-1.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s2-3.jpg"><img
				src="${res}/myImages/Home/s2-3.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s3-1.jpg"><img
				src="${res}/myImages/Home/s3-1.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
...
<li data-transition="random" data-slotamount="1"
				data-masterspeed="1000" data-saveperformance="off"
				data-thumb="${res}/myImages/Home/s3-2.jpg"><img
				src="${res}/myImages/Home/s3-2.jpg"				
				data-bgfit="cover" data-bgposition="center bottom"
				data-bgrepeat="no-repeat" />
